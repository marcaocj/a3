...
public class PlayerCombat : MonoBehaviour
{
    ...
    // Cache de método delegado
    private System.Action executeAttackDelegate;
    ...
    private void Awake()
    {
        ...
        // Cache do delegate para evitar alocações
        executeAttackDelegate = ExecuteAttack;
    }
    ...
    private bool CanPerformAttack()
    {
        ...
        return canAttack && 
               ...
               animationController != null && !animationController.IsPlayingSkill &&
               GameManager.Instance != null && GameManager.Instance.IsGamePlaying();
    }
    ...
    private List<GameObject> DetectEnemiesInAttackRange(AttackData attackData)
    {
        ...
        if (attackData == null || attackPoint == null) return detectedEnemies;
    ...
    {
        if (attackData == null || playerStats == null) return 0f;
